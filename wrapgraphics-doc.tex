...
\begin{description}
  ...
  \item[position] (\texttt{left}, \texttt{right} or \texttt{middle}) ---
    Which side of the image the text wraps around.
    \texttt{middle} centres the image and lets text flow between the
    left and right contour edges.
  ...
  \item[$\mathit{shift\_x}$] --- Horizontal offset of the image
    (e.g.\ \texttt{shift\_x=20pt}).  Positive = right.
  \item[$\mathit{shift\_y}$] --- Vertical offset of the image
    (e.g.\ \texttt{shift\_y=10pt}).  Positive = up.
    Does not affect text layout above the image; useful when the
    upper part of the image is transparent.
  \item[anchor] (\texttt{here}, \texttt{nw}, \texttt{ne},
    \texttt{sw} or \texttt{se}) --- Where to anchor the image.
    \texttt{here} (default) places it inline at the paragraph start.
    The compass-point values pin it to the corresponding corner
    of the text area (north-west = top-left, etc.).
\end{description}
...
\begin{figure}[h]
  \centering
  \preview[page=1,width=0.4\textwidth]{basic.pdf}
...
\begin{figure}[h]
  \centering
  \preview[page=1,width=0.4\textwidth]{comparison-left.pdf}
  \preview[page=1,width=0.4\textwidth]{comparison-right.pdf}
...
\begin{figure}[h]
  \centering
  \preview[page=1,width=0.4\textwidth]{comparison-left-hang.pdf}
  \preview[page=1,width=0.4\textwidth]{comparison-right-hang.pdf}
...
\begin{figure}[h]
  \centering
  \preview[page=1,width=0.4\textwidth]{params-threshold-03.pdf}
  \preview[page=1,width=0.4\textwidth]{params-threshold-08.pdf}
...
\begin{figure}[h]
  \centering
  \preview[page=1,width=0.4\textwidth]{params-padding-50.pdf}
  \preview[page=1,width=0.4\textwidth]{params-padding-00.pdf}
...
\begin{figure}[h]
  \centering
  \preview[page=1,width=0.4\textwidth]{lines.pdf}
...
\begin{figure}[h]
  \centering
  \preview[page=1,width=0.4\textwidth]{width.pdf}
...
\begin{figure}[h]
  \centering
  \preview[page=1,width=0.4\textwidth]{multiple.pdf}
...
\begin{figure}[h]
  \centering
  \preview[page=1,width=0.4\textwidth]{verbose.pdf}
...
\begin{figure}[h]
  \centering
  \preview[page=1,width=0.4\textwidth]{stickout.pdf}
  \caption{Large image with wrapping protruding into the margin.}
\end{figure}
...
\begin{figure}[h]
  \centering
  \preview[page=1,width=0.4\textwidth]{twocolumn.pdf}
...
\begin{figure}[h]
  \centering
  \preview[page=1,width=0.4\textwidth]{twocolumn-wide.pdf}
  \caption{Wide image spanning two columns.}
\end{figure}
...
\begin{figure}[h]
  \centering
  \preview[page=1,width=0.4\textwidth]{twocolumn-right.pdf}
  \caption{Right-side wrapping in two columns.}
\end{figure}

\clearpage
\subsection{Image shift}

The \texttt{shift\char`_x} and \texttt{shift\char`_y} keys move the
image without changing the wrapping contour.

\noindent Note: shifting does not affect text layout above the image;
it is most useful when the upper part of the image is transparent.

\begin{figure}[h]
  \centering
  \preview[page=1,width=0.4\textwidth]{shift.pdf}
  \caption{Image shifted right by 20\,pt and up by 10\,pt.}
\end{figure}

\clearpage
\subsection{Page corner anchors}

The \texttt{anchor} key pins the image to a text-area corner.
Text wrapping proceeds from that corner.

\begin{figure}[h]
  \centering
  \preview[page=1,width=0.4\textwidth]{anchor.pdf}
  \caption{Image anchored to the top-right corner (\texttt{anchor=ne}).}
\end{figure}

\clearpage
\subsection{Wrapping on both sides}

With \texttt{position=middle} the image is centered and text flows
between the left and right contour boundaries.

\begin{figure}[h]
  \centering
  \preview[page=1,width=0.4\textwidth]{wrap-mid.pdf}
  \caption{Image centred with bilateral text flow.}
\end{figure}
